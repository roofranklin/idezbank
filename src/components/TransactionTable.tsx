    ...
    return (
        <div className="flex flex-col w-full">
            <div className="flex flex-col gap-4 mb-6 pb-6 border-b border-gray-100">
                <div className="flex flex-col md:flex-row gap-4">
                    <div className="flex w-full gap-2 relative">
                        ...
                        <button
                            ...
                            className={`md:hidden p-3 rounded-2xl flex items-center justify-center transition-colors ${isFiltersOpen ? 'bg-indigo-100 text-indigo-600' : 'bg-gray-50/80 text-gray-500 hover:bg-gray-100/50'}`}
                        >
                    ...
                    <select
                        ...
                        className={`md:w-48 px-4 py-3 bg-gray-50/80 hover:bg-gray-100/50 border-none rounded-2xl text-sm focus:ring-0 outline-none cursor-pointer text-gray-900 font-medium transition-all ${!isFiltersOpen ? 'hidden md:block' : 'block'}`}
                    >
                ...
                <div className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 ${!isFiltersOpen ? 'hidden md:grid' : 'grid'}`}>
                    <DatePicker
                        selected={startDate}
