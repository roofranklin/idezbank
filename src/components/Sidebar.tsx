...
export function Sidebar({ isOpen, onClose }: SidebarProps) {
    return (
        <>
            ...
            <aside className={`w-64 bg-white flex flex-col h-screen fixed left-0 top-0 py-8 z-50 transform transition-transform duration-300 ease-out ${isOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 shadow-2xl lg:shadow-none overflow-y-auto`}>
